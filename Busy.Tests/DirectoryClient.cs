...
namespace Busy.Tests
{
    ...
    {
        [Test]
        public async Task ShouldRetrieveClients()
        {
            var busConfiguration = new BusConfiguration();

            var directoryClient = new PeerDirectoryClient(busConfiguration);
            ...
            var peer1Descriptor = new PeerDescriptor(peer1.Id, peer1.EndPoint, false, true, true, DateTime.Now, allParisKo, allParis);
            var peer2Descriptor = new PeerDescriptor(peer2.Id, peer2.EndPoint, false, true, true, DateTime.Now, allKo);
