...
namespace Busy
{
    public class MessageDispatcher : IMessageDispatcher
    {
        ...
        private ConcurrentDictionary<MessageTypeId, List<IMessageHandler>> _invokers = new ConcurrentDictionary<MessageTypeId, List<IMessageHandler>>();
        ...
        {
            _invokers = container.GetAllInstances<IMessageHandler>();
        }
